...
def Scifi_residuals(Nev=options.nEvents,NbinsRes=100,xmin=-2000.,alignPar=False,unbiased = True,minEnergy=False,remakeClusters=options.remakeScifiClusters):
    ...
    ut.bookHist(h,'Chi2/ndofVsE','track chi2/ndof vs muon energy',300,0,300,100,0,20)
...
# build trackCandidate
            ...
            if unbiased or s==1:
               ...
               rc = h['Chi2/ndofVsE'].Fill(event.MCTrack[0].GetPz(),fitStatus.getChi2()/(fitStatus.getNdf()+1E-10))
# check residuals
